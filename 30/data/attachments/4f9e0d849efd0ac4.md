...
Locator: getByText('Logged in as Jennifer Rodriguez')
Expected: visible
Timeout: 4000ms
...
Call log:
  ...
  - waiting for getByText('Logged in as Jennifer Rodriguez')
    ...
    - insertion [ref=e47]:
      - generic [ref=e50]:
        ...
        - link [ref=e53] [cursor=pointer]:
          - generic [ref=e54]: Subscription service management
          - img [ref=e56]
        - link [ref=e58] [cursor=pointer]:
          - generic [ref=e59]: API testing services
          - img [ref=e61]
        - link [ref=e63] [cursor=pointer]:
          - generic [ref=e64]: User account management
          - img [ref=e66]
  - iframe [ref=e69]:
