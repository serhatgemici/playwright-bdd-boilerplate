...
Locator: getByText('Logged in as Richard Gonzalez')
Expected: visible
Timeout: 4000ms
...
Call log:
  ...
  - waiting for getByText('Logged in as Richard Gonzalez')
  ...
  - insertion [ref=e63]:
    - generic [ref=e66]:
      ...
      - link [ref=e69] [cursor=pointer]:
        - generic [ref=e70]: Video tutorial creation
        - img [ref=e72]
      - link [ref=e74] [cursor=pointer]:
        - generic [ref=e75]: API testing services
        - img [ref=e77]
      - link [ref=e79] [cursor=pointer]:
        - generic [ref=e80]: E-commerce analytics tools
        - img [ref=e82]
```
